...
const Privacy = () => {
  return <>
    ...
    <p>
      <q>Ocean Gromits</q> stores no personally identifiable infomation either locally
    ...
    <p>
      ...
      the other <q>Gromit</q>, or by a trusted system administrator for the purposes of
      moderation.
    </p>
  </>
}
